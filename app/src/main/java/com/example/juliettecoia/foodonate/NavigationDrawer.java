...
public class NavigationDrawer extends AppCompatActivity{
    ...
    public static TheAccount logged_in_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras!=null) {
            ...
            String userAcceptDon = extras.getString("acceptDon");
            ...
            //logged_in_user = new TheAccount(userName, userOrg, userAddress, userPhone, userEmail, userAccptDon, userFood, userVerified);
            logged_in_user = new TheAccount(userName, userOrg, userAddress, userPhone, userEmail, userAcceptDon);
        }
